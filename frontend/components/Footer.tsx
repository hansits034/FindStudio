    ...
    <footer className="relative mt-32 border-t border-ink-700/40">
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-10 py-20">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              aria-label="WhatsApp"
              className="w-9 h-9 rounded-full border border-ink-700/40 flex items-center justify-center text-ink-300 hover:text-[#25D366] hover:border-green-500/50 transition"
            >
        ...
        <div className="mt-12 select-none">
          <div className="text-[14vw] leading-[0.85] font-display font-light text-ink-600/60 tracking-tightest">
            FindStudio<span className="text-amber-400/50">.</span>
          </div>
        </div>
      </div>
    </footer>
